...
public class DaliTridonicCommand extends DaliOperation {
   ...
   public DaliTridonicCommand(BDaliNetwork var1, boolean var2, int var3, int var4, int var5) {
      super(var1, var2, true, var4, var5, 0);
      this.bodyData[3] = (byte)var3;
   }

   public DaliTridonicCommand(BDaliNetwork var1, int var2, int var3, int var4) {
      super(var1, var3, var4, 0);
