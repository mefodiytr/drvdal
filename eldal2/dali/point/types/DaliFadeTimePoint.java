...
public class DaliFadeTimePoint extends DaliPoint {
   private static int daliCommandCode = 46;
   ...
   public BFacets getFacets() {
      return BFacets.makeEnum(BEnumRange.make(BFadeTime.TYPE));
   }

   public DaliFadeTimePoint(String var1) {
      super(var1, 165);
      this.daliPointValue = 0;
   }
}
