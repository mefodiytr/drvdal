...
public class DaliEmergencyModePoint extends DaliPoint {
   private int daliPointValue;

   public Type getPointType() {
      return BDaliEmergencyModeProxyPoint.TYPE;
   }

   public BControlPoint getProxyPoint() {
      return new BDaliEmergencyModeProxyPoint();
   }
   ...
   public DaliEmergencyModePoint(String var1) {
      super(var1, 250);
      this.daliPointValue = 0;
   }
}
